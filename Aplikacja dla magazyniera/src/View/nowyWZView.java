 ...
 * @author Przemek
 */
public class nowyWZView extends javax.swing.JFrame {

    /**
     * Creates new form nowyWZView
     */
    ...
    public WZ getWZ() {
        WZ wz = new WZ();
        wz.setKwota(Double.parseDouble(jXLabel9.getText()));
        wz.setDataWystawienia(jXDatePicker1.getDate());
        return wz; 
    }
