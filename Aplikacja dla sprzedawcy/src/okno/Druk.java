...
public class Druk {
    ...
    public void DrukFaktura(String id) throws SQLException {
        ...
        html = html + "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width:100%\">\n"
                ...
                + "			<td>&nbsp;</td>\n"
                + "			<td>\n"
                + "			<p><span style=\"font-size:8px;\">Nazwa: Hurtownia Sp. Z.o.o.</span></p>\n"
                + "\n"
                + "			<p><span style=\"font-size:8px;\">NIP: 2433835743 </span></p>\n"
                + "\n"
                + "			<p><span style=\"font-size:8px;\">Adres: Kaliska 24 </br>62-234 Kalisz</span></p>\n"
                + "			</td>\n"
                + "		</tr>\n"
                + "		<tr>\n"
                + "			<td>&nbsp;</td>\n"
     ...
     new PodgladDruk(html, this);

    }

    public void blok() throws SQLException {
