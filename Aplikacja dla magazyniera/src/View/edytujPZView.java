 ...
 * @author Przemek
 */
public class edytujPZView extends javax.swing.JFrame {

    /**
     * Creates new form edytujPZView
     */
    ...
    public void wypisz(ArrayList<pozycjaPZ> lista) {
        ...
        lista.stream().forEach((pozycjaPZ lista1) -> {
            DTM.addRow(new Object[]{lista1.getNazwa(), lista1.getIlosc(), lista1.getJm(), df.format(lista1.getCenaZ()),  df.format(lista1.getWartoscc()), lista1.getIdTowar(), lista1.getId()});
        });
    }

    public void ustawDane(PZ pz) {
        setTitle("Edytuj PZ " + pz.getNumer());
    ...
    public void usunWiersz(int row) {
        DTM.removeRow(row);
    }
    ...
    public PZ getPZ() {
        PZ pz = new PZ();
        pz.setKwota(Double.parseDouble(jXLabel9.getText()));
    ...
    public void addRow(Towar towar) {
        DTM.addRow(new Object[]{towar.getNazwa(), "", towar.getJednostkaMiary(), "", "", towar.getId()});
    }
    ...
    public void ustawSuma(double suma) {
        ...
        jXLabel9.setText(Double.toString(suma));
    }
