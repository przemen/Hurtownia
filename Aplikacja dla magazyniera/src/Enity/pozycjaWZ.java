...
public class pozycjaWZ
{
    ...
    public pozycjaWZ(String idTowar, String jm, String cenaZ, String wartoscc) {
    ...
    public pozycjaWZ(String id, String idTowar, String jm, String cenaZ, String wartoscc) {
        this.id = id;
        this.idTowar = idTowar;
        this.jm = jm;
        this.cenaZ = cenaZ;
