...
public class PrintUIComponent extends JPanel implements ActionListener,
    ...
    private JEditorPane  textAreaToPrint;
    ...
    public PrintUIComponent() {
        ...
        textAreaToPrint = new JEditorPane();
        
        textAreaToPrint.setSize(120, 120);
       ...
       // textAreaToPrint.append("<html><b style=\"color:pink\"></span></html>");
